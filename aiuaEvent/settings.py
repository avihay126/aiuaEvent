"""
Django settings for aiuaEvent project.
...
SECRET_KEY = 'django-insecure-d(0s(z84573xmrunn@irc*as*f!3)@%pgdl_u+cay7nj6bg4+3'
...
WSGI_APPLICATION = 'aiuaEvent.wsgi.application'
